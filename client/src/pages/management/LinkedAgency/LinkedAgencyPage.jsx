...
import LinkedAgencyTable from "./LinkedAgencyTable/LinkedAgencyTable";
import HeaderAD from "../../../components/auth/Header/Header";
import Sidebar from "../../../components/management/Sidebar/Sidebar";

const LinkedAgencyPage = () => {
  return (
    <div className="linked-agency-page">
      <Sidebar />
      ...
      <div className="main-mg">
        ...
        <div className="container-mg">
          <div className="header-mg">
            <span className="title-mg">Đơn vị liên kết</span>
          ...
          <div className="linked-agency-table-container">
            <LinkedAgencyTable />
          </div>
        </div>
      </div>
...
export default LinkedAgencyPage;
