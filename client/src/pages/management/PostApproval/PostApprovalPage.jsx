...
import PostApprovalTable from "./PostApprovalTable/PostApprovalTable";
      ...
      <div className="main-mg">
        ...
        <div className="container-mg">
          <div className="header-mg">
            <span className="title-mg">Duyệt bài đăng </span>
          ...
          <div className="post-approval-table-container">
            <PostApprovalTable />
          </div>
        </div>
      </div>
