    ...
    <div className="verify-code">
      ...
      <div className="verify-code-container">
        ...
        <div className="verify-code-form">
          ...
          <p className="verify-description">Nhập mã xác thực được gửi qua Email</p>
          ...
          <div className="button-group">
            ...
            <button className="verify-button" onClick={handleVerify} disabled={otp.length !== 6}>
              XÁC NHẬN
            </button>
          </div>
